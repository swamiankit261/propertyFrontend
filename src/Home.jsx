...
const Home = () => {
  ...
  const handleSearchSubmit = async () => {
    ...
    try {
      const { data } = await axios.get(`${BACKEND_URL}/property/allProperty?keyword=${address}`);

      if (data.success) {
        setFilteredData(data.data.properties);
        setSearched(true);
                      ...
                      <div className="tab__tabs">
                        {[0, 1, 2, 3, 4, 5, 6].map((index) => (
                          <div
                            ...
                            className={`tabChild list_header_semiBold pageComponent Ng500 ${activeTab === index ? "active" : ""
                              }`}
                            data-label={
                              index === 0
                                ? "BUY"
              ...
              <section class="ebsrpi-sec">
                <div class="container">
                  ...
                  <ul class="ebsrpi-list">
                    <li onClick={() => handleCitySearch("New Delhi")}>
                    ...
                    <li onClick={() => handleCitySearch("Mumbai")}>
                    ...
                    <li onClick={() => handleCitySearch("Gurgaon")}>
                    ...
                    <li onClick={() => handleCitySearch("Noida")}>
                    ...
                    <li onClick={() => handleCitySearch("Bangalore")}>
                    ...
                    <li onClick={() => handleCitySearch("Ahmedabad")}>
                    ...
                    <li onClick={() => handleCitySearch("Kolkata")}>
                    ...
                    <li onClick={() => handleCitySearch("Chennai")}>
                    ...
                    <li onClick={() => handleCitySearch("Hyderabad")}>
                    ...
                    <li onClick={() => handleCitySearch("Pune")}>
                    ...
                    <li onClick={() => handleCitySearch("Thane")}>
                    ...
                    <li onClick={() => handleCitySearch("Lucknow")}>
